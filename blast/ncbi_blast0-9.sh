...
-outfmt '6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore stitle' -out ~/scratch/ncbi_results/ast_ncbi.${PBS_ARRAYID}.out
